...
function consultarCPF(tipo) {
  ...
  if (tipo === 'detran') {
    ...
    window.location.href = 'intent://#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;package=br.gov.serpro.lince;S.browser_fallback_url=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dbr.gov.serpro.lince;end';
  } else if (tipo === 'serasa') {
