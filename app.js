...
async function gerarContrato(id, win) {
  ...
  var html = '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8">' +
    ...
    '<div class="cl"><strong>4.5 Cobrança por Quilometragem Excedente:</strong> O valor semanal da locação inclui uma franquia de <strong>900 km por semana</strong>. Caso a quilometragem percorrida ultrapasse esse limite, será cobrado <strong>R$ 0,20 (vinte centavos) por quilômetro excedente</strong>, somado ao valor semanal normal. A quilometragem será apurada pelo odômetro da motocicleta a cada ciclo semanal. Exemplo: percorridos 1.260 km na semana — 360 km excedentes × R$ 0,20 = R$ 72,00 adicionais ao valor semanal.</div>' +
    ...
    '<div class="cl"><strong>5.11</strong> O uso da motocicleta fica limitado a, no máximo, <strong>18 (dezoito) horas por dia</strong>. O uso contínuo ou acumulado superior a esse limite, apurado pelo rastreador veicular instalado no veículo, será considerado <strong>indício de cessão ou sublocação não autorizada</strong>, nos termos da cláusula 5.3, autorizando o Locador a rescindir imediatamente o contrato, recolher a motocicleta e reter o caução, sem prejuízo das demais penalidades previstas neste instrumento.</div>' +
    '<div class="cl"><strong>5.13 Responsabilidade por Acidente sob Efeito de Substâncias:</strong> Caso o Locatário se envolva em acidente de trânsito e seja constatado, por laudo médico, boletim de ocorrência ou qualquer outro meio de prova, que estava sob efeito de álcool, drogas ilícitas ou <strong>medicamentos que contraindiquem a direção de veículos</strong>, o Locatário será integralmente responsável pelos danos causados à motocicleta, devendo ressarcir o Locador pelo <strong>valor FIPE do veículo</strong> vigente na data do sinistro, independentemente do estado dos danos ou da existência de seguro. O caução será retido integralmente e o valor restante cobrado judicialmente se necessário.</div>' +
    '<div class="cl"><strong>5.12 Pagamento Prévio de Multas de Trânsito e Direito de Recurso:</strong> O Locatário deverá efetuar o pagamento de toda e qualquer multa de trânsito lavrada durante o período de locação dentro do prazo estabelecido pelo órgão autuador, independentemente de concordar ou não com a autuação. Caso deseje interpor recurso administrativo, o <strong>pagamento da multa é condição prévia e obrigatória</strong> — o recurso não suspende a obrigação de pagamento. Se o recurso for julgado procedente e a multa cancelada, o Locador reembolsará integralmente o valor pago ao Locatário no prazo de <strong>5 (cinco) dias úteis</strong> após o recebimento da notificação oficial de cancelamento. O não pagamento da multa no prazo, mesmo na pendência de recurso, autoriza o Locador a cobrar o valor diretamente do caução.</div>' +
    ...
    '<div class="cl"><strong>7.1 Prazo Mínimo e Prorrogação Automática:</strong> O prazo mínimo desta locação é de <strong>30 (trinta) dias</strong>, contados a partir da data de início indicada neste contrato. Após o término desse prazo inicial, caso nenhuma das partes manifeste intenção de encerramento, o contrato se prorroga automaticamente por <strong>prazo indeterminado</strong>, mantendo-se todas as condições aqui estabelecidas, com pagamentos semanais conforme acordado.</div>' +
    '<div class="cl"><strong>7.2 Encerramento pelo Locatário:</strong> O Locatário somente poderá solicitar o encerramento do contrato após o cumprimento integral do prazo mínimo de <strong>30 (trinta) dias</strong>. A solicitação deverá ser comunicada ao Locador com antecedência mínima de <strong>5 (cinco) dias úteis</strong>. Todos os valores devidos até a data de encerramento permanecem exigíveis integralmente. A devolução da motocicleta antes do término dos 30 dias iniciais <strong>não exime o Locatário do pagamento do período mínimo contratado</strong>.</div>' +
    ...
    '<div class="cl"><strong>7.6 Veículo Reserva:</strong> O Locador <strong>não disponibiliza veículo reserva</strong> em casos de manutenção preventiva, pane mecânica ou qualquer problema de ordem técnica. <strong>Exceção:</strong> em caso de <strong>colisão</strong>, o Locador poderá disponibilizar um veículo reserva enquanto a motocicleta estiver em reparo, a critério exclusivo do Locador e conforme disponibilidade. O período em que o veículo estiver parado para reparos de responsabilidade do Locador, sem veículo reserva disponível, poderá ser descontado proporcionalmente do valor da próxima parcela, mediante acordo entre as partes.</div>' +
    '<div class="cl"><strong>7.5 Encerramento pelo Locador:</strong> O Locador poderá encerrar o contrato a <strong>qualquer momento</strong>, independentemente do prazo mínimo ou de qualquer justificativa, bastando comunicar o Locatário com antecedência mínima de <strong>24 (vinte e quatro) horas</strong>. O Locatário não terá direito a qualquer indenização em razão do encerramento pelo Locador, sendo devolvido o caução após o prazo de verificação previsto na cláusula 6.4, descontadas as eventuais pendências.</div>' +

    '<div class="sec">8. Ausência de Vínculo Empregatício</div>' +
    '<div class="cl"><strong>8.1</strong> O presente instrumento é exclusivamente um <strong>contrato de locação de veículo</strong>, regido pelo Código Civil Brasileiro, e <strong>não caracteriza, em nenhuma hipótese, relação de emprego ou vínculo empregatício</strong> entre o Locador e o Locatário, nos termos dos arts. 2º e 3º da Consolidação das Leis do Trabalho (CLT).</div>' +
    '<div class="cl"><strong>8.2</strong> O Locatário é um <strong>profissional autônomo e independente</strong>, responsável por definir seus próprios horários, rotas e atividades. O Locador não exerce qualquer poder de direção, controle ou subordinação sobre a atividade exercida pelo Locatário com o veículo locado.</div>' +
    '<div class="cl"><strong>8.3</strong> O Locatário é o único responsável pelo recolhimento de seus encargos previdenciários (INSS), tributos, obrigações fiscais e qualquer outro ônus decorrente de sua atividade profissional, não cabendo ao Locador qualquer responsabilidade trabalhista ou previdenciária.</div>' +
    '<div class="cl"><strong>8.4</strong> Qualquer alegação de vínculo empregatício por parte do Locatário será considerada <strong>violação contratual grave</strong>, sujeitando-o ao pagamento de todas as custas judiciais, honorários advocatícios e eventuais danos causados ao Locador em decorrência de tal alegação infundada.</div>' +
    '<div class="sec">9. Em caso de conflito</div>' +
    '<div class="cl"><strong>9.1</strong> Qualquer problema que não seja resolvido entre as partes será tratado no foro da Comarca de Fortaleza/CE.</div>' +
