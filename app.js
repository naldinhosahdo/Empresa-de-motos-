...
async function gerarContrato(id, win) {
  ...
  var html = '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8">' +
    ...
    '<div class="cl"><strong>5.8</strong> Como condição para o início da locação, o Locatário se compromete a realizar, no aplicativo <strong>Carteira Digital de Trânsito (CDT)</strong>, a aceitação da transferência do veículo objeto deste contrato para si como <strong>condutor principal</strong>, procedimento este efetuado pelo Locador previamente à entrega das chaves. O não cumprimento desta obrigação no prazo de <strong>24 (vinte e quatro) horas</strong> a contar da assinatura deste instrumento faculta ao Locador suspender a locação sem ônus.</div>' +
