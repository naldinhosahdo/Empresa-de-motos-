...
async function gerarContrato(id, win) {
  ...
  var html = '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8">' +
    ...
    '<div class="cl"><strong>5.9</strong> O Locatário não pode circular com o veículo a mais de <strong>200 km</strong> de distância do local de retirada. O descumprimento desse limite autoriza o Locador a recolher a moto imediatamente.</div>' +
