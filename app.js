...
async function gerarContrato(id, win) {
  ...
  var html = '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8">' +
    ...
    '<div class="cl"><strong>7.6 Veículo Reserva:</strong> O Locador <strong>não disponibiliza veículo reserva</strong> em nenhuma hipótese, incluindo casos de manutenção, pane mecânica, acidente ou qualquer outra ocorrência que deixe a motocicleta temporariamente indisponível. O período em que o veículo estiver parado para reparos de responsabilidade do Locador poderá ser descontado proporcionalmente do valor da próxima parcela, mediante acordo entre as partes.</div>' +
