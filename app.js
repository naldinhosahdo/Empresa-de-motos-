...
async function gerarContrato(id, win) {
  ...
  var html = '<!DOCTYPE html><html lang="pt-BR"><head><meta charset="UTF-8">' +
    ...
    '<div class="cl"><strong>4.5 Limite de Quilometragem Semanal:</strong> O uso da motocicleta fica limitado a <strong>1.000 km por semana</strong>. O descumprimento desse limite poderá ser considerado uso excessivo do veículo, sujeitando o Locatário a cobranças adicionais e eventual rescisão do contrato pelo Locador.</div>' +
